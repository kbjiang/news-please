...
my_local_download_dir_article = './cc_download_articles_0222_0225/'
# hosts (if None or empty list, any host is OK)
my_filter_valid_hosts = []  # example: ['elrancaguino.cl']
# start date (if None, any date is OK as start date), as datetime
my_filter_start_date = datetime.datetime(2022, 2, 22)
# end date (if None, any date is OK as end date), as datetime
my_filter_end_date = datetime.datetime(2022, 2, 25)
...
my_warc_files_start_date = datetime.datetime(2022, 2, 22)
my_warc_files_end_date = datetime.datetime(2022, 2, 25)
